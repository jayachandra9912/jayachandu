...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex items-center p-14  justify-center bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-600 text-white relative overflow-hidden">
